...
class Test(AndroidCheck):
    ...
    @precondition(lambda self: self.device(text="/storage/emulated/0").exists() and not self.device(text="Properties").exists())
    @rule()
...
t = Test(
    ...
    device_serial="emulator-5554",
    output_dir="output/amaze/2079/random_100/1",
    policy_name="random",
    timeout=21600,
    number_of_events_that_restart_app = 100
)
